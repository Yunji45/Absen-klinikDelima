<nav class="navbar navbar-expand-lg main-navbar ">
    ...
    <ul class="navbar-nav navbar-right">
          ...
          <!-- @if (Auth::user()->foto == 'default.jpeg')
                            <img id="image" src="{{ asset('/storage/default.jpeg') }}" alt="" class="rounded-circle mr-1">
                        @else
                            <img id="image" src="{{ asset(Storage::url(Auth::user()->foto)) }}" alt="{{ Auth::user()->foto }}" class="rounded-circle mr-1">
                        @endif -->
    ...
    <!-- <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown">
        <a href="{{('logout')}}" class="dropdown-item has-icon text-white">
                    <i class="fas fa-sign-out-alt"></i> Logout
                </a>
