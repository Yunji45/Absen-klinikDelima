...
<section class="section">
          ...
          <div class="section-body">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="{{route('dash.estetika')}}">Estetika</a>
              </li>
            </ul>
            <div class="row">
        ...
        <script src="{{asset('stisla/dist/assets/js/dash-layanan/layanan-estetika.js')}}"></script>
        <script src="{{asset('stisla/dist/assets/js/dash-layanan/search-layanan-estetika.js')}}"></script>
@endsection