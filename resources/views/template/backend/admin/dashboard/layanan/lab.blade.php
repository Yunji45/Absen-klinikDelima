...
<section class="section">
          ...
          <div class="section-body">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="{{route('dash.lab')}}">Laboratorium</a>
              </li>
              <li class="nav-item">
        ...
        <script src="{{asset('stisla/dist/assets/js/dash-layanan/layanan-lab.js')}}"></script>
        <script src="{{asset('stisla/dist/assets/js/dash-layanan/search-layanan-lab.js')}}"></script>
@endsection