     ...
     <div class="card">
       <div class="card-header">
         ...
         <div class="card-header-form">
            <form action="{{route('khitan.cari')}}" method="get">
                @csrf
           ...
           <table class="table table-striped table-md" id="myTable">
             ...
             <tbody>
                ...
                <tr>
                    ...
                    <th>{{$item->alamat}}</th>
                    <td>
                        <a href="{{route('dataset.khitan.delete',$item->id)}}" onclick="return confirm('Yakin akan dihapus?')" class="btn btn-outline-danger btn-sm">
