     ...
     <div class="card">
       <div class="card-header">
         ...
         <div class="card-header-form">
            <form action="{{route('estetika.cari')}}" method="get">
                @csrf
             ...
             <tbody>
                ...
                <tr>
                    ...
                    <td scope="col" class="text-center">
                        <a href="{{route('dataset.estetika.delete',$item->id)}}" onclick="return confirm('Yakin akan dihapus?')" class="btn btn-outline-danger btn-sm">
...
<div class="modal fade" id="kehadiran" tabindex="-1" role="dialog" aria-labelledby="kehadiranLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('dataset.estetika.store')}}" method="post">
                @csrf
...
<div class="modal-content">
    ...
    <form action="{{route('dataset.estetika.import')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal-body">
