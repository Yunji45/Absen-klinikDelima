             ...
             <tbody>
                @php $no =1; @endphp 
                                ...
                                <tr>
                                    ...
                                    <th>{{$item->alamat}}</th>
                                    <td>
                                        <a href="{{route('ranap.delete',$item->id)}}" onclick="return confirm('Yakin akan dihapus?')" class="btn btn-outline-danger btn-sm">
...
<div class="modal fade" id="kehadiran" tabindex="-1" role="dialog" aria-labelledby="kehadiranLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('dataset.ranap.store')}}" method="post">
                @csrf
