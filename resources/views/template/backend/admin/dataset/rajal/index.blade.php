     ...
     <div class="card">
       <div class="card-header">
         ...
         <div class="card-header-form">
            <form action="{{route('rajal.cari')}}" method="get">
                @csrf
           ...
           <table class="table table-striped table-md" id="myTable">
             ...
             <tbody>
                ...
                <tr>
                    ...
                    <td>{{$item->alamat}}</td>
                    <td>
                        <a href="{{route('rajal.delete',$item->id)}}" onclick="return confirm('Yakin akan dihapus?')" class="btn btn-outline-danger btn-sm">
...
<div class="modal fade" id="kehadiran" tabindex="-1" role="dialog" aria-labelledby="kehadiranLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('dataset.rajal.store')}}" method="post">
                @csrf
