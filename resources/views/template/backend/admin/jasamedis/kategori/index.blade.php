...
<section class="section">
    ...
    <div class="section-header">
        ...
        <a href="{{route('kategori.jasa.excel')}}" class="btn btn-success">
            <i class="fa fa-download">
                </i> Eksport Excel
        </a>
    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="myTable">
                                <tr>
                                    ...
                                    <th scope="col" class="text-center">Kode Layanan</th>
                                ...
                                <tr>
                                    ...
                                    <td scope="col" class="text-center">
                                        <a href="{{route('kategori.jasa.edit',$item->id)}}" onclick="return confirm('Yakin akan di edit?')" class="btn btn-success btn-sm">
                                            <i class="fas fa-edit"> Edit</i>
                                        </a>

                                    <a href="{{route('kategori.jasa.delete',$item->id)}}" onclick="return confirm('Yakin akan dihapus?')" class="btn btn-danger btn-sm">
