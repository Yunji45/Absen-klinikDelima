           ...
           <table class="table table-striped table-md" id="myTable">
             ...
             <tbody>
                ...
                <tr>
                    ...
                    <td>{{$item->bulan}}</td>
                    <td>
                        <a href="{{route('daftar.pasien.edit',$item->id)}}" onclick="return confirm('Yakin akan di edit?')" class="btn btn-outline-success btn-sm">
                            <i class="fas fa-edit"> Edit</i>
                        </a>

                    <a href="{{route('daftar.pasien.delete',$item->id)}}" onclick="return confirm('Yakin akan dihapus?')" class="btn btn-outline-danger btn-sm">
