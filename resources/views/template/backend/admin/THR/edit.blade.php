          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <form action="{{ route('thr.update',$thr->id) }}" method="post">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control @error('user_id') is-invalid @enderror" name="user_id" id="user_id">
                                    <option value="{{$thr->user->id}}">{{$thr->user->name}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control @error('pendidikan') is-invalid @enderror" name="pendidikan" id="pendidikan">
                                    <option value="{{$thr->pendidikan}}">{{$thr->pendidikan}}</option>
                        ...
                        <div class="form-group row" id="Bonus">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="gaji_terakhir" id="gaji_terakhir" class="form-control @error('Bonus') is-invalid @enderror" value="{{old('gaji_terakhir',$thr->gaji_terakhir)}}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control @error('pendidikan') is-invalid @enderror" name="index" id="index">
                                    <option value="{{$thr->index}}">{{$thr->index}}%</option>
                        ...
                        <div class="form-group row" id="Bonus">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="masuk" id="masuk" class="form-control @error('Bonus') is-invalid @enderror" value="{{old('masuk',$thr->masuk)}}">
                                @error('Bonus') <span class="invalid-feedback" role="alert">{{ $message }}</span> @enderror
                            </div>
                        </div>
