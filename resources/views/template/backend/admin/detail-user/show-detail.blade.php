              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="{{ asset(Storage::url($detail->user->foto)) }}" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4>{{ $detail->name }}</h4>
                      <p class="text-secondary mb-1">{{ $detail->user->role }}</p>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-dark">
                        : {{ $detail->status_pekerjaan}}
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Tes Psikologi</h6>
                    </div>
                    <div class="col-sm-9 text-dark">
                        : {{ $detail->tes_psikologi}}
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Mulai Bekerja</h6>
                    </div>
                    <div class="col-sm-9 text-dark">
                        : {{ $detail->hire_date}}
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Akhir Bekerja</h6>
                    </div>
                    <div class="col-sm-9 text-dark">
                        : {{ $detail->exit_date}}
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Nama Suami/Istri</h6>
                    </div>
                    <div class="col-sm-9 text-dark">
                        : {{ $detail->spouse_name}}
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-dark">
                        : {{ $detail->number_of_children}}
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Hoby</h6>
                    </div>
                    <div class="col-sm-9 text-dark">
                        : {{ $detail->hobbies}}
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info " target="__blank" href="{{route('download.detail.admin',$detail->id)}}">Download</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row gutters-sm">
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">assignment</i>Dokumen Status</h6>
                        <ul>
                            @foreach ($detail->user->dokumen as $dokumen)
                            <li>
                                <a
                                    href="{{ asset('storage/dok_pegawai/' . $detail->user->name . '/' . $dokumen->filename) }}"
                                    target="_blank">
                                    {{ $dokumen->filename }}
                                </a>
                            </li>
