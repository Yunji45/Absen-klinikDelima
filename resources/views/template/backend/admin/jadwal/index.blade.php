...
<section class="section">
    ...
    <div class="row mt-5">
        ...
        <a href="{{ route('download.jadwal', ['bulan' => request('bulan', date('Y-m'))]) }}" class="btn btn-outline-danger">
        ...
        <a href="" class="btn btn-outline-danger" data-toggle="modal" data-target="#hapussemua">
            <i class="fa fa-trash">
                </i>Hapus Semua
        </a>
...
<div class="modal fade" id="kehadiran" tabindex="-1" role="dialog" aria-labelledby="kehadiranLabel" aria-hidden="true">
        ...
        <div class="modal fade" id="hapussemua" tabindex="-1" role="dialog" aria-labelledby="kehadiranLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="kehadiranLabel"> Delete Multiple {{$title}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{route('jadwal.destroy-all')}}" method="GET">
                    @csrf
                    <div class="modal-body">
                        <h5 class="mb-3">{{ date('l, d F Y') }}</h5>
                        <div class="form-group row">
                            <label for="bulan" class="col-form-label col-sm-3">Hapus Data</label>
                            <div class="col-sm-9">
                                <select class="form-control @error('bulan') is-invalid @enderror" name="bulan" id="bulan">
                                    <option value="">Pilih</option>
                                    <option value="01">January</option>
