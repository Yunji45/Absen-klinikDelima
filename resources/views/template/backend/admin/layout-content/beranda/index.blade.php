...
<section class="section">
          <div class="section-header">
            ...
            <h1>Beranda Settings</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
              <div class="breadcrumb-item active"><a href="#">Settings</a></div>
              <div class="breadcrumb-item">Beranda Settings</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">All About Beranda Settings</h2>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="nav nav-pills flex-column">
                      <li class="nav-item"><a href="{{route('setting-content.beranda')}}" class="nav-link active">Beranda</a></li>
              ...
              <div class="col-md-8">
                <form action="{{route('setting-content.beranda.save')}}" id="setting-form" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="card" id="settings-card">
                    <div class="card-header">
                      <h4>Beranda Settings</h4>
                    </div>
                    <div class="card-body">
                      <p class="text-muted">Beranda settings such as, site title, site description, address and so on.</p>
