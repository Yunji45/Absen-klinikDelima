          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <form action="{{route('note-karyawan.updatelagi',$catatan->id)}}" method="put">
                        @csrf
                        <div class="form-group row">
                            ...
                            <select class="form-control @error('pendidikan') is-invalid @enderror" name="user_id" id="user_id">
                                    <option value="{{$catatan->user_id}}">{{$catatan->user->name}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control @error('pendidikan') is-invalid @enderror" name="keterangan" id="keterangan">
                                    <option value="{{$catatan->keterangan}}">{{$catatan->keterangan}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="bulan" id="bulan" class="form-control @error('hire_date') is-invalid @enderror" value="{{old('bulan',$catatan->bulan)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="4">{{old('deskripsi',$catatan->deskripsi)}}</textarea>
