...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="mitradelima/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
  <link href="mitradelima/assets/vendor/animate.css/animate.min.css" rel="stylesheet">
  <link href="mitradelima/assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="mitradelima/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="mitradelima/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="mitradelima/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="mitradelima/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="mitradelima/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="mitradelima/assets/css/style.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="{{route('auth.index')}}" class="appointment-btn scrollto"><span class="d-none d-md-inline">Sign</span> In</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="member-img">
                <img src="mitradelima/assets/img/doctors/doctors-2.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="member-img">
                <img src="mitradelima/assets/img/doctors/doctors-3.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="400">
              <div class="member-img">
                <img src="mitradelima/assets/img/doctors/doctors-4.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Klinik Mitra Delima</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="">Ihya Natik Wibowo</a>
      </div>
    </div>
  </footer><!-- End Footer -->
  ...
  <!-- Vendor JS Files -->
  <script src="mitradelima/assets/vendor/purecounter/purecounter_vanilla.js"></script>
  <script src="mitradelima/assets/vendor/aos/aos.js"></script>
  <script src="mitradelima/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="mitradelima/assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="mitradelima/assets/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="mitradelima/assets/vendor/php-email-form/validate.js"></script>

  <!-- Template Main JS File -->
  <script src="mitradelima/assets/js/main.js"></script>
