...
<div class="container">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="" class="btn btn-sm btn-success" title="{{$title}}" data-id="{{ $item->id }}" data-toggle="modal" data-target="#edit">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="kehadiranLabel">Tambah Data Payroll</h5>
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="kehadiranLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="kehadiranLabel">Edit Payroll</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
